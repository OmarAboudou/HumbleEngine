...
// Nœud de rendu stocké dans le tableau plat du RenderTree.
// Taille fixe quelle que soit la nature du nœud.
// Les données spécifiques au type sont dans les tableaux typés du RenderTree,
// accessibles via Index.
public readonly struct RenderEntry
{
    public RenderEntryKind Kind   { get; init; }  // quel type de nœud
