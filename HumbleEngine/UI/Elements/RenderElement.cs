...
public static class RenderElementExtensions
{
    ...
    public static T When<T>(this T el, bool condition, Func<T, T> thenStyle, Func<T, T>? elseStyle = null) where T : RenderElement
        => condition ? thenStyle(el) : elseStyle != null ? elseStyle(el) : el;
